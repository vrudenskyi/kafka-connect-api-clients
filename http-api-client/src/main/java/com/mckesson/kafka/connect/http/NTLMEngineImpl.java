...
final class NTLMEngineImpl {
  ...
  private static final byte[] MAGIC_TLS_SERVER_ENDPOINT = "tls-server-end-point:".getBytes(DEFAULT_CHARSET);

  private static byte[] getNullTerminatedAsciiString(final String source) {
    final byte[] bytesWithoutNull = source.getBytes(DEFAULT_CHARSET);
  ...
  static class NTLMMessage {
    ...
    public String getResponse() {
      return new String(Base64.encodeBase64(getBytes()), DEFAULT_CHARSET);
    }
